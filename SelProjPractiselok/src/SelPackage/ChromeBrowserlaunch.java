...
public class ChromeBrowserlaunch {
	...
	public static void main(String[] args) 
	{
		...
		dr.findElement(By.xpath("//input[@name='login']")).click();
		 ...
		 dr.findElement(By.xpath("//input[1][@value='oneway']")).click();
		...
		//Filling Details on Registration Page
		
		//Contact Information
		dr.findElement(By.xpath("//input[@name='firstName']")).sendKeys("mercury");
		dr.findElement(By.xpath("//input[@name='lastName']")).sendKeys("mercury");
		dr.findElement(By.xpath("//input[@name='phone']")).sendKeys("mercury");
		dr.findElement(By.xpath("//input[@name='userName']")).sendKeys("mercury");
		
		//Mailing Information
		
		dr.findElement(By.xpath("//input[@name='address1']")).sendKeys("mercury");
		dr.findElement(By.xpath("//input[@name='address2']")).sendKeys("mercury");
		dr.findElement(By.xpath("//input[@name='city']")).sendKeys("mercury");
		dr.findElement(By.xpath("//input[@name='state']")).sendKeys("mercury");
		dr.findElement(By.xpath("//input[@name='postalCode']")).sendKeys("mercury");
		
		
		Select drpCountry = new Select(dr.findElement(By.name("country")));
		drpCountry.selectByVisibleText("SUDAN");
		
		
		//User Information
		
		dr.findElement(By.xpath("//input[@name='email']")).sendKeys("mercury");
		dr.findElement(By.xpath("//input[@name='password']")).sendKeys("mercury");
		dr.findElement(By.xpath("//input[@name='confirmPassword']")).sendKeys("mercury");
